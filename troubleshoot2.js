...
var fixPrinter = function() {
    ...
    switch(true){
        case boolPrinting === true && boolRedLight === true && boolRecognised === true://printer doesn't print, red light is on, and printer not recognised
            stringOutput = stringMessage2 + " " + stringMessage3 + " " + stringMessage4;
            break;
        case boolPrinting === true && boolRedLight === true && boolRecognised === false://printer doesn't print, red light is on
            stringOutput = stringMessage4 + " " + stringMessage5;
            break;
        case boolPrinting === true && boolRedLight === false && boolRecognised === true://printer doesn't print, printer not recognised
            stringOutput = stringMessage1 + " " + stringMessage2 + " " + stringMessage3;
            break;
        case boolPrinting === true && boolRedLight === false && boolRecognised === false://printer doesn't print
            stringOutput = stringMessage5;
            break;
        case boolPrinting === false && boolRedLight === true && boolRecognised === true://red light on, printer not recognized
            stringOutput = stringMessage3 + " " + stringMessage4;
            break;
        case boolPrinting === false && boolRedLight === true && boolRecognised === false://red light on
            stringOutput = stringMessage4;
            break;
        case boolPrinting === false && boolRedLight === false && boolRecognised === true://printer is unrecognized
            stringOutput = stringMessage3;
            break;
        case boolPrinting === false && boolRedLight === false && boolRecognised === false://no issues reported
